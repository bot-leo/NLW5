...
export function Welcome(){
  // [] um vetor com duas posição, que ira armazenar o conteudo do estado
  // visible: que fica com o valor do elemento
  // setVisible: função que atualiza esse valor do elemento(estado)
